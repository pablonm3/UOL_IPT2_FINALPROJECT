...
function NextButton(x=20, y=20, width=20, height=20){
	...
	this.draw = function(x=20, y=20, width=20, height=20){
	    ...
	    triangle(this.x, actual_y, this.x, actual_y+actual_height, this.x + triangle_width, actual_y + actual_height/2);
        sec_triangle_x = this.x+triangle_width
        triangle(sec_triangle_x, actual_y, sec_triangle_x, actual_y+actual_height, sec_triangle_x + triangle_width, actual_y + actual_height/2);
        pop()
	};
